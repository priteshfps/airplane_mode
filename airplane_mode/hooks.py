...
# 	],
	"daily": [
		"airplane_mode.airport_shop_management.utilities.utility.CheckContract_SetAvailable"
 	],
# 	"hourly": [
...
# 	],
 	"monthly": [
 		"airplane_mode.airport_shop_management.utilities.utility.send_Payment_Reminder_email_to_tenant"
 	],
}
